...
export const LEVELS: LevelConfig[] = [
  ...
  },
  {
    ...
    source: { x: 4, y: 26 },
    mirrors: [
      { id: "m1", pos: { x: 16, y: 26 }, misalignedRotation: 35, alignedRotation: 0, requiredTaps: 3 },
      { id: "m2", pos: { x: 32, y: 26 }, misalignedRotation: -30, alignedRotation: 0, requiredTaps: 2 },
      { id: "m3", pos: { x: 50, y: 26 }, misalignedRotation: 30, alignedRotation: 0, requiredTaps: 3 },
      { id: "m4", pos: { x: 68, y: 26 }, misalignedRotation: -35, alignedRotation: 0, requiredTaps: 3 },
      { id: "m5", pos: { x: 86, y: 26 }, misalignedRotation: 30, alignedRotation: 0, requiredTaps: 2 },
    ],
    diyas: [
    ...
    elephantSize: 130,
    obstacles: [
      { id: "o1", pos: { x: 24, y: 26 }, kind: "stone", blocking: true, moving: true, range: 5 },
      { id: "o2", pos: { x: 41, y: 26 }, kind: "pot", blocking: true },
      { id: "o3", pos: { x: 59, y: 26 }, kind: "stone", blocking: true, moving: true, range: 7 },
      { id: "o4", pos: { x: 77, y: 26 }, kind: "pot", blocking: true, moving: true, range: 5 },
    ],
    brightness: 0.82,
  },
];
